...
func ParseRewardDistributionData(reader io.Reader, v1WalletAddress, v2WalletAddress eth.Address, v2RewardOnly bool) ([]flareContracts.RewardsV2InterfaceRewardClaimWithProof, error) {
