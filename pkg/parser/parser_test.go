...
func TestParseRewardDistributionData(t *testing.T) {
	...
	// Parse the test data
	claims, err := ParseRewardDistributionData(reader, eth.HexToAddress(testFTOSV1Wallet), eth.HexToAddress(testFTOSV2Identity), false)
...
func TestParseRewardDistributionData_InvalidJSON(t *testing.T) {
	...
	claims, err := ParseRewardDistributionData(strings.NewReader(invalidJSON), eth.HexToAddress(testFTOSV1Wallet), eth.HexToAddress(testFTOSV2Identity), false)
